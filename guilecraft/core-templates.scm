...
;; defined in data-types/sets.scm.
;;
...
(define-module (guilecraft core-templates)
...
;;;;; Re-exports?
;;;
;;; Procedures currently re-exported from (guilecraft data-types sets).
;;; These procedures are likely to be developed into more convenient content
;;; creation templates.

;; Problem creation
(define (problem . args) (apply (@ (guilecraft data-types sets) problem) args))

;; Question creation
(define (q . args) (apply (@ (guilecraft data-types sets) q) args))

;; Solution creation
(define (s . args) (apply (@ (guilecraft data-types sets) s) args))

;; Option creation
(define (o . args) (apply (@ (guilecraft data-types sets) o) args))

;; Predicate creation
(define (p . args) (apply (@ (guilecraft data-types sets) p) args))

;; Media creation
(define (media . args) (apply (@ (guilecraft data-types sets) media) args))
