...
(define-module (guilecraft components)
...
relative to EXTENSIONS-DIR, in the (guilecraft config) context."
...
(define (module-name file guilecraft-dir)
...
COMPONENTS-DIR as its base."
      ...
      (define prefix-len (string-length guilecraft-dir))
