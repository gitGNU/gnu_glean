...
(define-module (glean core-templates)
...
;;;;; Re-exports?
;;;
;;; Procedures currently re-exported from (glean data-types sets).
;;; These procedures are likely to be developed into more convenient content
;;; creation templates.

;; Problem creation
(define (problem . args) (apply (@ (glean data-types sets) problem) args))

;; Question creation
(define (q . args) (apply (@ (glean data-types sets) q) args))

;; Solution creation
(define (s . args) (apply (@ (glean data-types sets) s) args))

;; Option creation
(define (o . args) (apply (@ (glean data-types sets) o) args))

;; Predicate creation
(define (p . args) (apply (@ (glean data-types sets) p) args))

;; Media creation
(define (media . args) (apply (@ (glean data-types sets) media) args))
